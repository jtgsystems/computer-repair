...
### C:\Users\Owner\Desktop\DEV Projects\Web_Projects\PC BOY\computer-repair\components\ui\pagination.tsx
#### Element 1 (Button)
- **Has Navigation**: No
- **Empty Navigation**: No
- **Element**: `<ButtonProps, "size">`
...
### C:\Users\Owner\Desktop\DEV Projects\Web_Projects\PC BOY\computer-repair\app\service-areas\markham\page.tsx
#### Element 1 (Button)
- **Has Navigation**: No
- **Empty Navigation**: No
- **Element**: `<Button size="lg" asChild>`
...
- **Element**: `<Link
            ...
            className="bg-[#1D4D84] hover:bg-[#4B6E97] t...`
...
- **Has Navigation**: No
- **Empty Navigation**: No
- **Element**: `className="bg-[#1D4D84] hover:bg-[#4B6E97] text-white px-4 py-2 rounded-md mt-4"
          >
       ...`
...
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `href="/services/service1"`

#### Element 8 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `href="/services/service2"`

#### Element 9 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `href="/services/service3"`

### C:\Users\Owner\Desktop\DEV Projects\Web_Projects\PC BOY\computer-repair\src\components\NavBar\NavBar.jsx
#### Element 1 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `<Link to="/" className={styles.logo} onClick={closeMenu}>`

#### Element 2 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `<Link to="/" className={styles.navLink} onClick={closeMenu}>`

#### Element 3 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `<Link to="/services" className={styles.navLink} onClick={closeMenu}>`

#### Element 4 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `<Link to="/about" className={styles.navLink} onClick={closeMenu}>`

#### Element 5 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `<Link to="/contact" className={styles.navLink} onClick={closeMenu}>`

#### Element 6 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `<Link to="/appointment" className={styles.navButton} onClick={closeMenu}>`

#### Element 7 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `yles.navItem}>
            <Link to="/appointment" className={styles.navButton} onClick={closeMenu}...`

#### Element 8 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `me={styles.navItem}>
...
### C:\Users\Owner\Desktop\DEV Projects\Web_Projects\PC BOY\computer-repair\src\components\NavBar\NewMenu.jsx
#### Element 1 (Link)
- **Has Navigation**: Yes
- **Empty Navigation**: No
- **Element**: `<Link to="/" className={styles.logo} onClick={closeMenu}>`
