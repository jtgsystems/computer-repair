...
export default function HealthcareIndustryPage() {
  return (
    <>
      ...
      <IndustryCTA
        heading="ENHANCE PATIENT CARE WITH ADVANCED TECHNOLOGY"
        description="Contact PC Mechanix today to discover how our specialized IT solutions can help your healthcare organization improve patient care while maintaining strict regulatory compliance."
      />
    </>
  );
}