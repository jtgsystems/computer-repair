...
export default function WarehousingIndustryPage() {
  return (
    <>
      ...
      <IndustryCTA
        heading="OPTIMIZE YOUR WAREHOUSE OPERATIONS WITH TECHNOLOGY"
        description="Contact PC Mechanix today to discover how our specialized IT solutions can help your warehousing business achieve greater efficiency and accuracy."
      />
    </>
  );
}