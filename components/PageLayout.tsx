            ...
            <nav className="flex flex-col space-y-4">
              ...
              {serviceItems.map((category, index) => (
                <details key={index} className="group">
                  <summary className="text-lg font-semibold cursor-pointer list-none flex items-center justify-between text-white hover:text-[#E4EDEF] uppercase tracking-wide transition-all duration-300 ease-in-out hover:bg-[#4B6E97] px-4 py-2 rounded">
                    {category.label}{" "}
